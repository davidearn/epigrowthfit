...
#'
#' @param text
#'   A \link{character} or \link{expression} vector. If the length
#'   is greater than 1, then only the string or expression with
#'   the maximum width or height is used to calculate the result.
#' @param target

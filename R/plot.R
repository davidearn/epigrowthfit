...
#' par(op)
#'
#' op <- par(mar = c(0.1, 1, 0.1, 1), oma = c(3.5, 0, 0.5, 9.5))
#' plot(x, type = "rt_heat", per_plot = 10L)
#' par(op)
#'
#' @export
...
#' @importFrom graphics par plot.new plot.window rect points polygon lines segments box title axTicks strwidth strheight grconvertX grconvertY mtext
...
#' @importFrom graphics par layout plot.new plot.window strwidth strheight grconvertX grconvertY title rect text

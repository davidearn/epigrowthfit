...
#' `breaks`. For \mjseqn{i \in \lbrace 1,\ldots,m \rbrace}, let
#' \mjseqn{p_i} be the probability specified by `probs[i]`. This is
#' the probability that the generation interval is in the interval
#' \mjseqn{\lbrack t_{i-1},t_i)}.

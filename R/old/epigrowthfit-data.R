...
#'     territories up to December 16, 2020.
#'   }
...
#'
#' @format
#' A data frame with 3592 rows and 4 variables:
#'
#' \describe{
#'   \item{`date`}{
#'     Date, daily (with exceptions) up to December 16, 2020 within
#'     each level of `province`. Start date ranges
#'     from February 4, 2020 (Ontario), to April 30, 2020 (Nunavut).
#'   }
#'   \item{`time`}{

...
## egf_link_match ######
    ...
    expect_identical(egf_link_match("logit", inverse = TRUE),
                     function(q) plogis(q),
                     ignore_function_env = TRUE)

test_that("object", {
  ...
  expect_equal(co2, cpo, ignore_attr = c("class", "method", "frame_windows", "A", "x"))
...
test_that("parallel", {
  ...
  co3_multicore <- confint(o, method = "uniroot", subset = (country == "A" & wave == 1),
  ...
  co3_snow <- confint(o, method = "uniroot", subset = (country == "A" & wave == 1),

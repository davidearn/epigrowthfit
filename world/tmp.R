...
do_plot(s, spar = spar, endpoints = l,
        xlim = as.Date(c("2020-12-01", "2021-05-01")),
        ylim = c(4,8))
...
#  [81] "KGZ" "KHM" "KOR" "KWT" "LBN" "LBR" "LBY" "LIE" "LKA" "LSO"
#  [91] "LTU" "LUX" "LVA" "MAR" "MCO" "MDA" "MDG" "MEX" "MLI" "MLT"
# [101] "MMR" "MNG" "MOZ" "MRT" "MUS" "MWI" "MYS" "NAM" "NER" "NGA"
# [111] "NIC" "NLD" "NOR" "NPL" "NZL" "OMN" "PAK" "PAN" "PER" "PHL"

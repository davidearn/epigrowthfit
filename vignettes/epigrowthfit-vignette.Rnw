...
must be added to the search path. With Rtools 40, this can be
done by running
...
<<rtools-2, eval=FALSE>>=
writeLines('PATH="C:\\Rtools\\bin;${PATH}"',
  con = "~/.Renviron"
)
@
%
assuming that Rtools was installed to \code{C:\\Rtools}.


\subsubsection{From the remote repository}
...
\subsubsection{From a local repository}

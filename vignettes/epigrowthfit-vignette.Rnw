...
the search path. Users with Rtools 40 (compatible with R 4.0.0
...
Rtools 35 (compatible with R 3.3.0--3.6.3)\ldots
\mikael{Consistent installation instructions for Rtools 35?}
